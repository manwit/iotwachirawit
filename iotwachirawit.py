...
channel_secret = "dd576eb0a635fac8ac3e75ddc3b0a5ab"
channel_access_token = "4Z47SNrGOxAYHNsSplBXVgOvXwLu7fLvfBFZa37erhMtEhbzUoTqwW2CRuWaiO8p25yqSW7+5jgupkrljOyTaaViph5A+r1ypxZXsjsiN9+nHt8A3MJMgyNpTDUpygnT4+qxglLWcFQApKubEySfyQdB04t89/1O/w1cDnyilFU="

broker_address= "mqtt.netpie.io"
port = 1883

client = mqttClient.Client("4a81e853-28b2-49fd-b3b3-7d836e500d54") # Client ID
user = "TbSq5SiWF4MV9zonAZ314k1xp9ZB36K2" # Token
password = "_rp4MrhlAc~f~U1dl~n7SrlsZ!NdL2YK" # Secret
